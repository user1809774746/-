...
**功能描述**: 更新旅行计划的开始日期和结束日期，并自动更新 `travelDays`
    ...
    "dailyItineraries": [
      {
        ...
        "date": "2025-11-15",
        "city": "北京",
        "createdAt": "202 5-11-14T10:00:00"
      }
    ]
  }
}
...
```json
{
  "id": 1,                          // 必填：景点ID（与活动ID相同）
  "name": "故宫博物院",              // 必填：景点名称
  "ticketPriceAdult": 60.00,        // 可选：成人票价
...
```json
{
  ...
  "latitude": 39.916527,            // 可选：纬度
  "openingHours": "08:30-17:00",    // 可选：开放时间
  "mustSeeSpots": ["太和殿", "乾清宫", "御花园"],  // 可选：必看景点（JSON数组）
  "tips": "建议提前网上购票"         // 可选：温馨提示
}
```
